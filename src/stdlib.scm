...
(define (memq obj lst)
    (fold
        (__mem-helper (curry eq? obj) id)
        #f lst
    )
)
(define (memv obj lst)
    (fold
        (__mem-helper (curry eqv? obj) id)
        #f lst
    )
)
(define (member obj lst)
    (fold
        (__mem-helper (curry equal? obj) id)
        #f lst
    )
)
(define (assq obj alist)
    (fold
        (__mem-helper (curry eq? obj) car)
        #f alist
    )
)
(define (assv obj alist)
    (fold
        (__mem-helper (curry eqv? obj) car)
        #f alist
    )
)
(define (assoc obj alist)
    (fold
        (__mem-helper (curry equal? obj) car)
        #f alist
    )
)
